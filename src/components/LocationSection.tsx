...
export default function LocationSection() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative py-28 overflow-hidden bg-[#FDFBF7] bg-pattern-dots">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="location-header text-center mb-14">
          <div className="inline-flex items-center gap-2 mb-5 px-4 py-2 rounded-full border border-gray-200 bg-gray-50">
            ...
            <span className="text-[var(--gold)] text-xs tracking-[0.3em] uppercase font-medium">Find Us</span>
            <span className="text-[var(--gold)] text-xs">✦</span>
          </div>
        ...
        <div className="location-grid grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="location-info-card space-y-6">
            {/* Address */}
            <div className="contact-detail p-6 rounded-2xl border border-gray-200 bg-card flex gap-4">
              ...
              <div>
                <p className="text-gray-900 font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>Address</p>
                <p className="text-gray-600 text-sm leading-relaxed">Mahatma Gandhi Road (MG Road)<br />Shalimar, Nashik<br />Maharashtra, India</p>
                <a
                  href="https://maps.google.com/?q=Jagannath+Restaurant+MG+Road+Nashik"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-[var(--gold)] text-xs mt-2 hover:text-gray-900 transition-colors"
                >
            ...
            <div className="contact-detail p-6 rounded-2xl border border-gray-200 bg-card flex gap-4">
              ...
              <div className="flex-1">
                <p className="text-gray-900 font-bold mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>Opening Hours</p>
            ...
            {/* Contact */}
            <div className="contact-detail p-6 rounded-2xl border border-gray-200 bg-card space-y-4">
              <p className="text-gray-900 font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>Get in Touch</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm font-medium">+91 99752 60955</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm font-medium">info@jaijagannath.com</p>
                </div>
              </div>
            </div>
          ...
          <div className="location-map">
            <div className="relative rounded-2xl overflow-hidden border border-gray-200 h-full min-h-[500px]">
              <iframe
              ...
              <div className="absolute top-4 left-4 p-3 rounded-xl border border-gray-200"
                style={{ background: "rgba(255,255,255,0.9)", backdropFilter: "blur(10px)" }}>
                <p className="text-[var(--gold)] font-bold text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>Jai Jagannath</p>
                <p className="text-gray-600 text-xs">MG Road, Shalimar, Nashik</p>
              </div>
            </div>
          </div>
        </div>
